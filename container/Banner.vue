  ...
  <div class="hompage-baner">
    ...
    >
      <div class="containe">
        ...
        <a class="button btn btn-banner" :style="item.color">
          {{ item.btn }}
        </a>
      </div>
    </div>
...
<script>
import Banner1 from "../assets/images/baner1.svg";
      ...
      arrData: [
        {
          background: Banner1,
          img: Draft,
          title: "더 쉽고 빠르게, 더 높은 품질로!",
          description: "특허 명세서 작성 전용 에디터",
          btn: "특허 명세서 작성하러 가기",
        ...
        },
        {
          background: Banner2,
          img: Translate,
          title: "번역에 필요한 모든 고민은 IPEDIT가 대신 해드리겠습니다.",
          description: "특허 명세서 번역 전용 에디터",
          btn: "특허 명세서 번역하러 가기",
          color: "color: #8d6e63 !important",
